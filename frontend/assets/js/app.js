...
function configurarMenuVisitante() {
    const menuMobile =
        document.getElementById("mobile-menu");
    ...
    const botaoCadastro =
        menuMobile.querySelector("button");
...
function configurarLinksDaPagina() {
    const links =
        document.querySelectorAll(
            ".nav a, #mobile-menu a, .footer__links a"
        );
